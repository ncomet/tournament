...
import io.github.ncomet.tournament.infrastructure.persistence.score.DynamoDbAllScoresModule
...
class PlayersServiceModule {
    @Provides
    @Singleton
    fun playersService(allScores: AllScores, allPlayers: AllPlayers): PlayersService = PlayersService(allScores, allPlayers)
}